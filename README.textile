...
This has only been tested with Rails 2.2 so far. It probably won't work with Rails 1.x. If you try it with another tallersion, please let me know and I'll update this document (and try to fix the problem).
